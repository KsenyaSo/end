...
namespace project
{
    public partial class Form1 : Form
    {
        ...
        private static readonly HashSet<char> Glas = new HashSet<char>("аеёиоуыэяю"),
        ...
        private IEnumerable<string> GetSyllables(string word)
        {
            var syllable = new StringBuilder();
            bool case1(int index) => word[index] == 'й' && Soglas.Contains(word[index + 1]);
            ...
            for (; GlasLeft(word, i) > 1 || syllable.Length != 0; i++)
            {
                ...
                if (case1(i) ||
                    case2(i) ||
                    Glas.Contains(word[i]) && !(case1(i+1) || case2(i+1)))
                {
